...
class OtpServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendOtp = channel.unary_unary(
                ...
                request_serializer=service__pb2.SendOtpRequest.SerializeToString,
                response_deserializer=service__pb2.SendOtpResponse.FromString,
...
def add_OtpServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendOtp': grpc.unary_unary_rpc_method_handler(
                    servicer.SendOtp,
                    request_deserializer=service__pb2.SendOtpRequest.FromString,
                    response_serializer=service__pb2.SendOtpResponse.SerializeToString,
            ),
    }
...
class OtpService(object):
    ...
    def SendOtp(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/otp.OtpService/SendOtp',
            service__pb2.SendOtpRequest.SerializeToString,
            service__pb2.SendOtpResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
